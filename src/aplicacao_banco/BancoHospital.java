...
public void consulta2(Connection conexao) throws SQLException{
	...
	ResultSet resultado = comando.executeQuery(sql);
	while(resultado.next()){
		String num_pront = resultado.getString("num_pront");
		String primeiro_nome = resultado.getString(2);
		String sobrenome = resultado.getString(3);
		System.out.println(num_pront + "\t\t" + primeiro_nome + "\t\t" + sobrenome);
	}
	comando.close();
	}
...
//		}
	...
	public void consulta5(Connection conexao) throws SQLException {
		...
		Statement comando = conexao.createStatement();
		ResultSet resultado = comando.executeQuery(sql);
		System.out.println("especialidade" + "\t\t\t" + "salariomaximo" + "\t\t\t"  + "salariominimo");
		while (resultado.next()) {
			String especialidade = resultado.getString("especialidade");
			String salariomaximo = resultado.getString("salariomaximo");
			String salariominimo = resultado.getString("salariominimo");
			System.out.println(especialidade + "\t\t\t" + salariomaximo + "\t\t\t"  + salariominimo);
		}
		comando.close();
		}
	...
	public void consulta20(Connection conexao) throws SQLException{
...
public void consulta6(Connection conexao) throws SQLException {
	String sql = "SELECT COALESCE(P.primeiro_nome, 'SEM NOME') AS nomes\r\n" + 
...
public void consulta7(Connection conexao) throws SQLException {
	String sql = "SELECT med.nome AS medicamento, d.descricao\r\n" + 
			"FROM (SELECT *\r\n" + 
